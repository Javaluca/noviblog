...
export default function PostPreview({post}: {post: Post}) {
    ...
    return (
        <div className="flex flex-row lg:-ms-32 mb-12">
            ...
            <div className="flex-grow-1 max-h-80 flex flex-col">
                ...
                <div className={`prose lg:prose-xl max-w-none text-ellipsis overflow-hidden dark:text-slate-300 ${markdownStyles['markdown']}`}
